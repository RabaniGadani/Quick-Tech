      ...
      {admitData && (
        <div id="print-area">
          ...
          <div className="bg-teal-800 text-white p-4 rounded-t-lg flex justify-between items-center">
            ...
            <img src="/Logo-.png" alt="Academy Logo" className="h-12" />
          </div>

          {/* Content */}
          <div className="p-6 flex flex-col sm:flex-row gap-6 border-b border-gray-200">
            <div className="w-24 h-24 bg-gray-200 border border-teal-800 rounded-md flex-shrink-0">
              {admitData.imageUrl && (
                <img src={admitData.imageUrl} alt="Student" className="w-full h-full object-cover rounded-md" />
              )}
            </div>
          ...
          <table className="w-full border-collapse my-6 text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-teal-800 p-3">{admitData.institute || 'Quick Tech Institiute of Information Technology'}</td>
              </tr>
              <tr>
                <td className="border border-teal-800 p-3 font-semibold">Venue</td>
                <td className="border border-teal-800 p-3">{admitData.testVenue || 'Quick Tech Institiute of Information Technology, Gill Colony Near Hazaray Shah Muhalla, Mirpur Mathelo'}</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="text-left text-sm">
            ...
            <p className="mb-1">- Bring this admit card and a valid ID.</p>
